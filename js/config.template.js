...
const ID_DICT = {
  ...
  "Online booking page": "Halaman reservasi online",
  "Outlook": "Agenda",
  "Deposits & Payments": "Deposit & Pembayaran",
  "Deposit rules": "Aturan deposit",
  "Payment instructions": "Petunjuk pembayaran",
  "Guest Spending": "Belanja Tamu",
  "Membership & Rewards": "Keanggotaan & Hadiah",
  "Membership rules": "Aturan keanggotaan",
  "Spin Wheel Prizes": "Hadiah Roda Putar",
  "WhatsApp Messages": "Pesan WhatsApp",
  "Staff & Access": "Staf & Akses",
  "Expand sidebar": "Perluas navigasi",
  "Collapse sidebar": "Perkecil navigasi",
  "Open navigation": "Buka navigasi",
  "Close navigation": "Tutup navigasi",
  "Save booking rules": "Simpan aturan reservasi",
  "Save spending rules": "Simpan aturan belanja",
  "Save membership rules": "Simpan aturan keanggotaan",
  "Save deposit rules": "Simpan aturan deposit",
  "Save payment instructions": "Simpan petunjuk pembayaran",
  "Save tracking": "Simpan pelacakan",
  "Turning tracking off preserves historical records.": "Menonaktifkan pelacakan tetap menyimpan riwayat data.",
  "Area deposit amounts are managed in Areas & tables.": "Nominal deposit per area diatur di Area & meja.",
  "Only Admin can change bank details and QRIS. Managers can update the payment confirmation contact.": "Hanya Admin yang dapat mengubah rekening bank dan QRIS. Manajer dapat memperbarui kontak konfirmasi pembayaran.",
  ...
  "Choose a format": "Pilih format",
  "Simple deposit": "Deposit sederhana",
  "Detailed invoice: deposit and settlement": "Invoice rinci: deposit dan pelunasan",
  "Choose a deposit invoice format": "Pilih format invoice deposit",
  ...
  "Could not check table availability. Check the visit hours and database migrations, then retry.": "Ketersediaan meja belum dapat diperiksa. Periksa jam kunjungan dan migrasi database, lalu coba lagi.",
  "Wait for table availability to finish loading before saving.": "Tunggu pemeriksaan ketersediaan meja selesai sebelum menyimpan.",
  "Some selected tables are booked during this visit. Choose available tables or change the hours.": "Beberapa meja pilihan sudah dipesan pada jam kunjungan ini. Pilih meja tersedia atau ubah jamnya.",
