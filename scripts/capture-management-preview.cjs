...
async function navigateTo(page){odInvalidate();document.querySelectorAll('.page-section').forEach(el=>el.classList.remove('active'));document.body.classList.toggle('summary-dashboard-active',page==='dashboard');document.getElementById(page==='dashboard'?'page-owner-dashboard':'page-reservation-outlook').classList.add('active');await (page==='dashboard'?loadOwnerDashboard():loadReservationOutlook());}
